...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.hide_related_images'
        db.add_column('zinnia_entry', 'hide_related_images',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.hide_related_images'
        db.delete_column('zinnia_entry', 'hide_related_images')
    ...
    models = {
        ...
        'zinnia.entry': {
            ...
            'hide_related_images': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
